...
setTimeout(() => {
  async function _0x3a3346() {
    ...
    _0x236875.ev.on("messages.upsert", async _0x545c2c => {
      ...
      const _0x39e3a4 = [..._0x353ce7, _0x51e007, "254757835036", '254751284190', "254750948696", "254742063632", conf.NUMERO_OWNER].map(_0x437e90 => _0x437e90.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x2f20e9 = _0x39e3a4.concat(_0x432f97);
      const _0x337c52 = _0x2f20e9.includes(_0x3acd79);
      var _0x4e2580 = ["254757835036", '254751284190', "254750948696", "254742063632", ..._0x353ce7].map(_0x2d5aff => _0x2d5aff.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x3acd79);
      ...
      try {
        ...
        if (_0x2bd118.action == "add" && (await _0x48d9a4(_0x2bd118.id, "welcome")) == 'on') {
          ...
          if (_0x2bd118.action == "remove" && (await _0x48d9a4(_0x2bd118.id, 'goodbye')) == 'on') {
            let _0x5e9529 = "Goodbye to that Fallen soldier, Powered by *FLASH-MD*;\n";
