...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const king2 = "254750948696";
            const king3 = "254751284190';
...
`;
            ...
            msg += ` Welcome! Read the group description for more indo and a book avoid being removed! 
        ◇FRANCE KING ²0²⁴◇
◇ *GROUP DESCRIPTION* ◇
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("------------------/-----");
                console.log("Flash-Md is activated 🕸\n\n");
                ...
                let cmsg = `
╔════◇
║ 『FLASH-MD is CONNECTED』
║  Prefix : [ ${prefixe} ]
║  Mode :${md}
║  Commande : ${evt.cm.length}︎
╚═════════════════>
