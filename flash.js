...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const king='254757835036';
             const king1=*254742063632';
             const king2='254751284190'*/
            /*  var superUser=[servBot,king,king1,king2].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[king,king1,king2].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const king1 = '254742063632';
            const king2 = "254751284190";
            const king3 = '254750948696';
            const sudo = await getAllSudoNumbers();
            const superUserNumbers = [servBot, king, king1, king2, king3, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://telegra.ph/file/b53fec985d0a78eb40445.jpg';
    }
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            ...
            msg += ` Welcome!!
  Please read this group's description for more information and avoid being removed!
◇*GROUP DESCRIPTION*◇
...
🐐Powered by France King`;
            ...
            let msg = `Goodbye to that fallen soldier.. Let's not meet again;\n`;
